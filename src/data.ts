...
function exercise_from_filenames() {
  ...
  let files = [{"hints":["substring"],"name":"3.00-string-first"},{"hints":["<","string-length"],"name":"3.01-less-than-5"},{"hints":["string-append","substring"],"name":"3.01-pig-latin"},{"hints":["substring","sub1","string-length"],"name":"3.01-string-last"},{"hints":["substring","string-length"],"name":"3.02-string-rest"},{"hints":["if","zero?","string-length","substring","sub1"],"name":"3.03-string-remove-last"},{"hints":["substring","string-length","string-append","string-upcase"],"name":"3.04-formalize"},{"hints":["if",">","string-length","string-append","substring"],"name":"3.05-TLDR"},{"hints":["or",">="],"name":"3.06-can-ride"},{"hints":["*","image-width","image-height",">"],"name":"3.50-image-larger"},{"hints":["sqrt","+","sqr","-"],"name":"3.51-distance"},{"hints":["<=","cond","string=?"],"name":"4.00-failing-num"},{"hints":["cond","string=?"],"name":"4.01-failing-letter"},{"hints":["cond","string=?"],"name":"4.02-bump-up"},{"hints":["cond","string=?","and",">","<=",">="],"name":"4.03-num-2-letter"},{"hints":["cond","string=?"],"name":"4.04-give-reward"},{"hints":["cond","string=?"],"name":"4.05-demote"},{"hints":["cond","string=?","and",">=","<="],"name":"4.06-mmr-2-rank"},{"hints":["cond","string=?"],"name":"4.07-spicy-2-fire"},{"hints":["cond","string=?","and",">=","<"],"name":"4.08-scoville-2-spicy"},{"hints":["cond","string=?","or"],"name":"4.50-fall"},{"hints":["cond","string=?"],"name":"4.51-next-month"},{"hints":["cond","string=?","substring"],"name":"4.52-abbrev-month"},{"hints":["cond","string=?","substring"],"name":"4.53-format-month"},{"hints":["cond","string=?","substring","string-append","number->string"],"name":"4.54-year-month-day-2-date"},{"hints":["cond","string=?","+"],"name":"4.55-month-2-days-in-year"},{"hints":["cond","string=?","+","*"],"name":"4.56-year-month-day-2-days"},{"hints":["cond","string=?","+","*","abs","-"],"name":"4.57-days-between"},{"hints":["cond","and","boolean?","boolean=?","number?",">=","<=","string?","string=?","number->string"],"name":"5.00-countdown-to-image"},{"hints":["cond","and","boolean?","boolean=?","string?","string=?"],"name":"5.01-next-light"},{"hints":["cond","number?","boolean?","string-append","number->string"],"name":"5.02-broadcast-status"},{"hints":["cond","and","number?",">=","<=","string?","string=?"],"name":"5.03-can-walk"},{"hints":["cond","boolean?","number?","add1"],"name":"5.04-heal1"}]
  ;
